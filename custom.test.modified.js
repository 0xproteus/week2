...
describe('Custom Tests', function () {
    ...
    it('[assignment] ii. deposit 0.1 ETH in L1 -> withdraw 0.08 ETH in L2 -> assert balances', async () => {
        ...
        // withdraws a part of Alice funds from the shielded pool in L2
    ...
    it('[assignment] iii. see assignment doc for details', async () => {
        ...
        // Bob withdraws all his funds from the shielded pool in L2
        ...
        // withdraws all of Alice funds from the shielded pool in L1

        const aliceWithdrawAmount = aliceDepositAmount.sub(bobSendAmount)
        const aliceEthAddress = '0xe22619F6D538DE6E0B6c1845174D45e90cBd3576'
        ...
        expect(bridgeBalance).to.be.equal(aliceWithdrawAmount)
        const tornadoBalance = await token.balanceOf(tornadoPool.address)
        expect(tornadoBalance).to.be.equal(0)
